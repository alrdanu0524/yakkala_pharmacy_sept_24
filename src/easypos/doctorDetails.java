...
public class doctorDetails extends javax.swing.JFrame {
    ...
    jPanel3Layout.setHorizontalGroup(
        ...
        .addGroup(jPanel3Layout.createSequentialGroup()
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(txt_title, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(txt_description, javax.swing.GroupLayout.DEFAULT_SIZE, 326, Short.MAX_VALUE)
                .addComponent(dateChooserCombo1, javax.swing.GroupLayout.DEFAULT_SIZE, 326, Short.MAX_VALUE))
            .addContainerGap())
    );
    ...
    jTable1.setModel(new javax.swing.table.DefaultTableModel(
        ...
        new String [] {
            "Id", "Name", "Description", "Contact", "Date"
        }
    ));
    ...
    public void tbups() {
        ...
        try {
            ...
            dtm.setRowCount(0);
            ResultSet rs = MC_DB.search_dataQuery("SELECT * FROM doctorDetails");
            while (rs.next()) {
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        ...
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = MC_DB.search_dataQuery("SELECT * FROM doctorDetails WHERE discription like '" + key + "' or name like '" + key + "' or date like '" + key + "'");
            while (rs.next()) {
...
txt_amount.grabFocus();
    ...
    private void myButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButton3ActionPerformed
        String id = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
        try {
            MC_DB.insert_data("DELETE FROM doctorDetails WHERE id = '" + id + "'");
    ...
    private void myButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButton2ActionPerformed
        ...
        try {
            ...
            MC_DB.insert_data("UPDATE doctorDetails set user ='" + user + "' ,name = '" + title + "',discription = '" + description + "', contact = '" + amount + "',  date = '" + date + "' where id = '" + id + "'");
    ...
    private void myButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButton1ActionPerformed
        ...
        try {
            MC_DB.insert_data("INSERT INTO doctorDetails (discription, contact, date,name,user) values ( '" + description + "', '" + amount + "', '" + date + "','" + title + "','" + user + "' )");
    ...
    private void set_details(String id) {
        try {
            ResultSet rs = MC_DB.search_dataQuery("SELECT * FROM doctorDetails WHERE id = '" + id + "'");
            if (rs.next()) {
                txt_description.setText(rs.getString("discription"));
                txt_title.setText(rs.getString("name"));
                txt_amount.setText(rs.getString("contact"));
